...
**Always use `group_id: "Servus-raffle"`** for all Graphiti operations (add_memory, search_nodes, search_facts, get_episodes, etc.).

This project uses a single namespace for all knowledge to ensure:

- All context is available in one place
